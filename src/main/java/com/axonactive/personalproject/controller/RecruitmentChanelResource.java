...
public class RecruitmentChanelResource {
    ...
    public  ResponseEntity<RecruitmentChanel> update(@PathVariable("id") Integer id, @RequestBody RecruitmentChanel inputData) throws ResourceNotFoundException {
        RecruitmentChanel updatingRecruitmentChanel = recruitmentChanelService.findById(id).orElseThrow(()->new ResourceNotFoundException("Can't not find Application Form with that id."));
    ...
    public ResponseEntity<Void> delete(@PathVariable("id") Integer id) throws ResourceNotFoundException {
        RecruitmentChanel deletingRecruitmentChanel = recruitmentChanelService.findById(id).orElseThrow(()->new ResourceNotFoundException("Can't not find Application Form with that id."));
