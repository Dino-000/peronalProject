...
public interface WorkingHistoryRecordService {
    ...
    WorkingHistoryRecordDto update (WorkingHistoryRecordRequest request,Integer id) throws EntityNotFoundException;
    WorkingHistoryRecord convertFromRequestToEntity (WorkingHistoryRecordRequest request) throws EntityNotFoundException;
