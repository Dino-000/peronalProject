...
public interface CandidateRepository extends JpaRepository<Candidate, Integer> {
  ...
  @Query(value = "SELECT w.candidate " + "FROM WorkingHistoryRecord w " + "WHERE w.teamSize <= ?1")
  ...
  @Query(value = "SELECT w.candidate " + "FROM WorkingHistoryRecord w " + "WHERE w.jobType =?1")
